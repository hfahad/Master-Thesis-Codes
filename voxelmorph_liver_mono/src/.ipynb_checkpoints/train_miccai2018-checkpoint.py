...
def train(data_dir,
    ...
    mono,multi= datagenerators.load_volume_liver(data_dir)
...
#random.shuffle(train_vol_names)  # shuffle volume list
    ...
    assert np.mod(batch_size, nb_gpus) == 0, \
     ...
     #------------------------------------- For mono model-------------------------------
    train_example_gen = datagenerators.example_gen(mono,batch_size=batch_size)
    ...
    with tf.device(gpu):
        ...
        # single gpu
            ...
            try:
                ...
                csv_logger=tf.keras.callbacks.CSVLogger('../Models/mono_model_250_0.2/training.log')
            except:
                pass
            mg_model = model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", type=str,
                        dest="model_dir", default='../Models/mono_model_250_0.2',
                        help="models folder")
